      ...
      <TowColumn>
        <TowColumn.Main>
          <PostBody>
            <h2>Taiです</h2>
            <p>
              Railsエンジニア2年目。React/TypeScript/Next.jsの学習用サイト
              <br />
              興味が出てきたのでフロント学習しています。
              <br />
              今後は個人開発や学習したことを中心に追加していく予定です。
            </p>
            <h3>やりたいこと</h3>
            <p>
              - バックエンド開発は業務で困らないくらいまで頑張る。
              <br />
              - フロントエンドは副業できるくらいまで頑張る。
              <br />- 英語は仕事・プライベート共に困らないくらいにはなりたい。
            </p>
