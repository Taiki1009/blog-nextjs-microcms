...
const Practice = () => {
  return (
    <>
    <div className="container mt-16 flex justify-between items-center px-8 md:px-14 lg:px-24 w-full" id="practice">
      <div className="flex flex-wrap md:flex-nowrap">
        ...
        <div className="block w-10/12 mt-12 right-6 md:w-3/5 md:mt-0 lg:w-3/6 lg:top-2 lg:right-52 -z-10">
          <Image src={"/images/human.jpg"} className="w-10/12 md:w-3/5 lg:w-3/6 mt-12 right-6 md:mt-0 lg:top-2 lg:right-52 -z-10" layout="fill" objectFit='contain' alt="image" />
